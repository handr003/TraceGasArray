...
CO2sumsub <- subset(CO2sumsub, Date > as.POSIXct("2018-08-21 08:04:40"))
...
#If instrument times are not perfectly synced then they may need to be corrected. Here, they were off by around 15 seconds

N2Odata$DateNum <- (N2Odata$DateNum + 140) #insert offset here (in seconds) if it is a fixed time
NOxdata$DateNum <- (NOxdata$DateNum  + 160) #insert offset here (in seconds) if it is a fixed time
###
